...
const BrookeImagePath = '/static/images/party/bride/brooke_lucas.jpg';
    ...
    return (
      <Layout container="true" title="Meet the Party">
        ...
        <div
          ...
          />
          <PartyMember name="Brooke" img={BrookeImagePath} blurb="Lorem" />
          <PartyMember
            name="Kahli"
            img={KahliImagePath}
          ...
          <PartyMember
            ...
            blurb="Lorem"
          />
          <PartyMember name="Natalie" img={NatalieImagePath} blurb="Lorem" />
          <PartyMember name="Paige" img={PaigeImagePath} blurb="Lorem" />
        </div>
        <hr />
        ...
        <div
          ...
          <PartyMember name="Ryan" img={RyanImagePath} />
          <PartyMember name="Tyler" img={TylerImagePath} />
        </div>
      </Layout>
    );
  }
